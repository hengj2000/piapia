...
(function($) { 
    $(function(){
        ...
        $("#textContent").ThinkEditor({"width":"600px","uploadURL":"/index.php/Public/editor_up"
        });
    });
})(jQuery);
                                    ...
                                    <tr>
                                        ...
                                        <td class="tLeft">
                                            <select name="categoryId" class="medium text">
                                                <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate["id"]); ?>"><?php echo ($cate["title"]); endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
